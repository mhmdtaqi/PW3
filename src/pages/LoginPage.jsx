...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const loginUrl = import.meta.env.DEV ? "/api/user/login" : "https://brainquiz0.up.railway.app/user/login";
      ...
      <div className="relative z-10 max-w-lg w-full space-y-12">
        ...
        <div className="card-glass rounded-3xl shadow-ultra p-10 border border-white/30 animate-slide-up backdrop-ultra">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <Button type="submit" className="w-full btn-primary text-lg py-4 font-black">
